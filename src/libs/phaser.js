...
(function() {
    ...
    b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v1.5.2", b.blendModes = {
        ...
        this.style.dropShadow && (g += this.style.dropShadowDistance), this.canvas.width = g;
...
function() {
    ...
    PIXI.InteractionManager = function() {}, b.Utils = {
        ...
        restart: function(a, b) {
            "undefined" == typeof a && (a = !0), "undefined" == typeof b && (b = !1), this._pendingState = this.current, this._clearWorld = a, this._clearCache = b, arguments.length > 3 && (this._args = Array.prototype.splice.call(arguments, 3))
        },
        dummy: function() {},
        preUpdate: function() {
        ...
        add: function(a) {
            var b = !1;
            return "function" == typeof a ? a = new a(this.game, this._parent) : (a.game = this.game, a.parent = this), "function" == typeof a.preUpdate && (a.hasPreUpdate = !0, b = !0), "function" == typeof a.update && (a.hasUpdate = !0, b = !0), "function" == typeof a.postUpdate && (a.hasPostUpdate = !0, b = !0), "function" == typeof a.render && (a.hasRender = !0, b = !0), "function" == typeof a.postRender && (a.hasPostRender = !0, b = !0), b ? ((a.hasPreUpdate || a.hasUpdate || a.hasPostUpdate) && (a.active = !0), (a.hasRender || a.hasPostRender) && (a.visible = !0), this._len = this.plugins.push(a), "function" == typeof a.init && a.init(), a) : null
        },
        remove: function(a) {
        ...
        return "undefined" == typeof b && (b = !1), 0 === this.children.length ? !1 : (a.events && a.events.onRemovedFromGroup.dispatch(a, this), this.removeChild(a), this.updateZ(), this.cursor === a && this.next(), b && a.destroy(), !0)
    }, b.Group.prototype.removeAll = function(a) {
        if ("undefined" == typeof a && (a = !1), 0 !== this.children.length) {
            do this.children[0].events && this.children[0].events.onRemovedFromGroup.dispatch(this.children[0], this), this.removeChild(this.children[0]), a && this.children[0].destroy(); while (this.children.length > 0);
            this.cursor = null
        }
        ...
        if ("undefined" == typeof b && (b = this.children.length), "undefined" == typeof c && (c = !1), 0 !== this.children.length) {
            ...
            for (var d = b; d >= a;) this.children[d].events && this.children[d].events.onRemovedFromGroup.dispatch(this.children[d], this), this.removeChild(this.children[d]), c && this.children[d].destroy(), this.cursor === this.children[d] && (this.cursor = null), d--;
            this.updateZ()
        }
        ...
        reset: function() {
            this.isDown = !1, this.isUp = !0, this.timeUp = this.game.time.now, this.duration = this.game.time.now - this.timeDown, this.enabled = !0, this.onDown.removeAll(), this.onUp.removeAll(), this.onHoldCallback = null, this.onHoldContext = null
        },
        ...
        removedFromGroup: function() {
            this.enabled ? (this._wasEnabled = !0, this.stop()) : this._wasEnabled = !1
        },
        reset: function() {
            this.enabled = !1;
        ...
        for (this.canvas.height = g * b.length, navigator.isCocoonJS && this.context.clearRect(0, 0, this.canvas.width, this.canvas.height), this.context.fillStyle = this.style.fill, this.context.font = this.style.font, this.context.strokeStyle = this.style.stroke, this.context.lineWidth = this.style.strokeThickness, this.context.shadowOffsetX = this.style.shadowOffsetX, this.context.shadowOffsetY = this.style.shadowOffsetY, this.context.shadowColor = this.style.shadowColor, this.context.shadowBlur = this.style.shadowBlur, this.context.textBaseline = "top", this.context.lineJoin = "round", e = 0; e < b.length; e++) {
        ...
        var f, g = 0,
            h = a,
            i = b;
        for (this._frames = b; c > g;) "object" == typeof a && (h = this.game.rnd.pick(a)), "object" == typeof b && (i = this.game.rnd.pick(b)), f = new this.particleClass(this.game, 0, 0, h, i), this.game.physics.arcade.enable(f, !1), d ? (f.body.checkCollision.any = !0, f.body.checkCollision.none = !1) : f.body.checkCollision.none = !0, f.body.collideWorldBounds = e, f.exists = !1, f.visible = !1, f.anchor.copyFrom(this.particleAnchor), this.add(f), g++;
        return this
    ...
    return function a(b, c, d) {
        ...
        12: [
            function(a, b) {
                ...
                function f(a, b, c, d) {
                    for (var e = P, f = Q, j = R, k = S, l = a, m = b.vertices, n = null, o = 0; o !== m.length + 1; o++) {
                        var p = m[o % m.length],
                            q = m[(o + 1) % m.length];
                ...
                var g = a("../math/vec2"),
                    ...
                    n = a("../shapes/Circle"),
                    o = a("../shapes/Shape"),
                    p = (a("../objects/Body"), a("../shapes/Rectangle"));
                b.exports = c;
                var q = g.fromValues(0, 1),
                    r = g.fromValues(0, 0),
                    s = g.fromValues(0, 0),
                    t = g.fromValues(0, 0),
                    u = g.fromValues(0, 0),
                ...
                c.prototype.collidedLastStep = function(a, b) {
                    ...
                    return g.copy(b.contactPointA, a.contactPointA), g.copy(b.contactPointB, a.contactPointB), g.rotate(b.t, a.normalA, -Math.PI / 2), b.contactEquation = a, b
                ...
                c.prototype[o.CAPSULE | o.CAPSULE] = c.prototype.capsuleCapsule = function(a, b, c, d, f, h, i, j, k) {
                    ...
                    var n = r,
                        ...
                        F = z,
                        G = J;
                    numContacts = 0, g.set(n, -f.length / 2, 0), g.set(o, f.length / 2, 0), g.rotate(p, n, l), g.rotate(A, o, l), i(p, p, k), i(A, A, k), g.copy(n, p), g.copy(o, A), h(B, o, n), g.normalize(C, B), g.rotate(F, C, -Math.PI / 2), g.rotate(E, q, d), G[0] = n, G[1] = o;
                    for (var H = 0; H < G.length; H++) {
                        ...
                        if (0 > K) {
                            ...
                            numContacts++, g.copy(L.normalA, E), g.normalize(L.normalA, L.normalA), g.scale(D, E, K), h(L.contactPointA, I, D), h(L.contactPointA, L.contactPointA, a.position), h(L.contactPointB, I, k), i(L.contactPointB, L.contactPointB, k), h(L.contactPointB, L.contactPointB, e.position), this.contactEquations.push(L), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(L))
                        }
                    }
                    return numContacts
                    ...
                    var p = f,
                        ...
                        K = b,
                        n = n || 0,
                        o = "undefined" != typeof o ? o : K.radius,
                        L = r,
                        M = s,
                        N = t,
                        O = u,
                    ...
                    if (h(O, S, G), h(X, H, G), Math.abs($) < o + n) {
                        ...
                        if (_ > ab && bb > _) {
                            if (m) return !0;
                            var cb = this.createContactEquation(I, F, b, f);
                            return g.scale(cb.normalA, L, -1), g.normalize(cb.normalA, cb.normalA), g.scale(cb.contactPointA, cb.normalA, o), i(cb.contactPointA, cb.contactPointA, H), h(cb.contactPointA, cb.contactPointA, I.position), h(cb.contactPointB, N, G), i(cb.contactPointB, cb.contactPointB, G), h(cb.contactPointB, cb.contactPointB, F.position), this.contactEquations.push(cb), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(cb)), 1
                        }
                    }
                    Z[0] = S, Z[1] = T;
                    for (var db = 0; db < Z.length; db++) {
                        ...
                        if (h(W, eb, H), g.squaredLength(W) < (o + n) * (o + n)) {
                            if (m) return !0;
                            var cb = this.createContactEquation(I, F, b, f);
                            return g.copy(cb.normalA, W), g.normalize(cb.normalA, cb.normalA), g.scale(cb.contactPointA, cb.normalA, o), i(cb.contactPointA, cb.contactPointA, H), h(cb.contactPointA, cb.contactPointA, I.position), h(cb.contactPointB, eb, G), g.scale(Y, cb.normalA, -n), i(cb.contactPointB, cb.contactPointB, Y), i(cb.contactPointB, cb.contactPointB, G), h(cb.contactPointB, cb.contactPointB, F.position), this.contactEquations.push(cb), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(cb)), 1
                        }
                    }
                    return 0
                    ...
                    for (var T = 0; T !== verts.length + 1; T++) {
                        ...
                        if (g.rotate(C, U, p), g.rotate(H, V, p), i(C, C, w), i(H, H, w), h(I, H, C), g.normalize(J, I), g.rotate(K, J, -Math.PI / 2), g.scale(O, K, -z.radius), i(O, O, x), f(O, o, w, p)) {
                            g.sub(P, C, O);
                    ...
                    if (R) {
                        ...
                        return g.sub(X.normalA, Q, x), g.normalize(X.normalA, X.normalA), g.scale(X.contactPointA, X.normalA, n), i(X.contactPointA, X.contactPointA, x), h(X.contactPointA, X.contactPointA, y.position), h(X.contactPointB, N, w), i(X.contactPointB, X.contactPointB, w), h(X.contactPointB, X.contactPointB, q.position), this.contactEquations.push(X), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(X)), 1
                    }
                    if (n > 0)
                        for (var T = 0; T < verts.length; T++) {
                            var Y = verts[T];
                            if (g.rotate(M, Y, p), i(M, M, w), h(L, M, x), g.squaredLength(L) < n * n) {
                                if (m) return !0;
                                var X = this.createContactEquation(y, q, b, j);
                                return g.copy(X.normalA, L), g.normalize(X.normalA, X.normalA), g.scale(X.contactPointA, X.normalA, n), i(X.contactPointA, X.contactPointA, x), h(X.contactPointA, X.contactPointA, y.position), h(X.contactPointB, M, w), i(X.contactPointB, X.contactPointB, w), h(X.contactPointB, X.contactPointB, q.position), this.contactEquations.push(X), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(X)), 1
                            }
                        }
                    return 0
                };
                ...
                c.prototype[o.PARTICLE | o.CONVEX] = c.prototype[o.PARTICLE | o.RECTANGLE] = c.prototype.particleConvex = function(a, b, c, d, e, k, l, m, n) {
                    var o = k,
                        ...
                        R = !1,
                        S = o.vertices;
                    if (!f(z, o, y, p)) return 0;
                    if (n) return !0;
                    for (var T = 0; T !== S.length + 1; T++) {
                        var U = S[T % S.length],
                            V = S[(T + 1) % S.length];
                        g.rotate(C, U, p), g.rotate(E, V, p), i(C, C, y), i(E, E, y), h(F, E, C), g.normalize(G, F), g.rotate(J, G, -Math.PI / 2), h(M, z, C); {
                            j(M, J)
                        }
                        h(K, C, y), h(L, z, y), g.sub(O, C, z);
                        var W = Math.abs(g.dot(O, J));
                        Q > W && (Q = W, g.scale(N, J, W), g.add(N, N, z), g.copy(P, J), R = !0)
                    }
                    if (R) {
                        var X = this.createContactEquation(B, q, b, k);
                        return g.scale(X.normalA, P, -1), g.normalize(X.normalA, X.normalA), g.set(X.contactPointA, 0, 0), i(X.contactPointA, X.contactPointA, z), h(X.contactPointA, X.contactPointA, B.position), h(X.contactPointB, N, y), i(X.contactPointB, X.contactPointB, y), h(X.contactPointB, X.contactPointB, q.position), this.contactEquations.push(X), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(X)), 1
                    }
                    return 0
                    ...
                    if (l) return !0;
                    var x = this.createContactEquation(o, s, b, f);
                    return h(x.normalA, u, q), g.normalize(x.normalA, x.normalA), g.scale(x.contactPointA, x.normalA, m), g.scale(x.contactPointB, x.normalA, -n), i(x.contactPointA, x.contactPointA, q), h(x.contactPointA, x.contactPointA, o.position), i(x.contactPointB, x.contactPointB, u), h(x.contactPointB, x.contactPointB, s.position), this.contactEquations.push(x), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(x)), 1
                }, c.prototype[o.PLANE | o.CONVEX] = c.prototype[o.PLANE | o.RECTANGLE] = c.prototype.planeConvex = function(a, b, d, e, f, k, l, m, n) {
                    var o = f,
                        p = l,
                        u = k,
                        v = m,
                        ...
                        D = 0;
                    g.rotate(B, q, z);
                    for (var E = 0; E < u.vertices.length; E++) {
                        var F = u.vertices[E];
                        if (g.rotate(A, F, v), i(A, A, p), h(C, A, y), j(C, B) <= c.convexPrecision) {
                            if (n) return !0;
                            D++;
                            var G = this.createContactEquation(w, o, x, u);
                            h(C, A, y), g.copy(G.normalA, B);
                            var H = j(C, G.normalA);
                            g.scale(C, G.normalA, H), h(G.contactPointB, A, o.position), h(G.contactPointA, A, C), h(G.contactPointA, G.contactPointA, w.position), this.contactEquations.push(G), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(G))
                        }
                    }
                    return D
                    ...
                    var m = a,
                        ...
                        u = r,
                        v = s;
                    t = t || 0, h(u, n, p), g.rotate(v, q, t);
                    var w = j(u, v);
                    if (w > 0) return 0;
                    if (l) return !0;
                    var x = this.createContactEquation(o, m, f, b);
                    return g.copy(x.normalA, v), g.scale(u, x.normalA, w), h(x.contactPointA, n, u), h(x.contactPointA, x.contactPointA, o.position), h(x.contactPointB, n, m.position), this.contactEquations.push(x), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(x)), 1
                    ...
                    var m = a,
                        ...
                        q = j,
                        s = r;
                    if (h(s, q, o), g.squaredLength(s) > n.radius * n.radius) return 0;
                    if (l) return !0;
                    var t = this.createContactEquation(m, p, b, f);
                    return g.copy(t.normalA, s), g.normalize(t.normalA, t.normalA), g.scale(t.contactPointA, t.normalA, n.radius), i(t.contactPointA, t.contactPointA, o), h(t.contactPointA, t.contactPointA, m.position), h(t.contactPointB, q, p.position), this.contactEquations.push(t), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(t)), 1
                }; {
                    var T = new n(1),
                        U = g.create(),
                        V = g.create();
                ...
                c.prototype[o.PLANE | o.CAPSULE] = c.prototype.planeCapsule = function(a, b, c, d, e, f, h, j, k) {
                    ...
                    var x = r,
                        y = s,
                        z = t;
                    h(x, p, v), g.rotate(y, q, w);
                    var A = j(y, x);
                    if (A > o.radius) return 0;
                    if (m) return !0;
                    var B = this.createContactEquation(u, n, f, b);
                ...
                }, c.convexPrecision = 1e-7, c.prototype[o.CONVEX] = c.prototype[o.CONVEX | o.RECTANGLE] = c.prototype[o.RECTANGLE] = c.prototype.convexConvex = function(a, b, d, e, f, k, l, m, n, o) {
                    var p = r,
                        q = s,
                        w = t,
                        A = u,
                    ...
                    for (var J = 0; 2 > J; J++) {
                        ...
                        for (var V = L; L + 2 > V; V++) {
                            ...
                            for (var X = 0, Y = K - 1; K + 2 > Y; Y++) {
                                ...
                                g.rotate(w, Z, Q), g.rotate(A, $, Q), i(w, w, O), i(A, A, O), h(B, A, w), g.rotate(E, B, -Math.PI / 2), g.normalize(E, E), h(D, q, w);
                                var _ = j(E, D);
                                o >= _ && X++
                            }
                            if (X >= 3) {
                                ...
                                g.rotate(w, Z, Q), g.rotate(A, $, Q), i(w, w, O), i(A, A, O), h(B, A, w), g.rotate(ab.normalA, B, -Math.PI / 2), g.normalize(ab.normalA, ab.normalA), h(D, q, w);
                                var _ = j(ab.normalA, D);
                                g.scale(C, ab.normalA, _), h(ab.contactPointA, q, O), h(ab.contactPointA, ab.contactPointA, C), i(ab.contactPointA, ab.contactPointA, O), h(ab.contactPointA, ab.contactPointA, S.position), h(ab.contactPointB, q, P), i(ab.contactPointB, ab.contactPointB, P), h(ab.contactPointB, ab.contactPointB, T.position), this.contactEquations.push(ab), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(ab))
                            }
                        }
                    }
                    return F
                };
                var W = g.fromValues(0, 0);
                ...
                c.findSeparatingAxis = function(a, b, d, e, f, i, j) {
                    for (var k = null, l = !1, m = !1, n = X, o = Y, p = Z, q = $, r = _, s = ab, t = 0; 2 !== t; t++) {
                        var u = a,
                            v = d;
                        1 === t && (u = e, v = i);
                        for (var w = 0; w !== u.vertices.length; w++) {
                            ...
                            r[0] > s[0] && (y = r, x = s, z = !0);
                            var A = y[0] - x[1];
                            l = A <= c.convexPrecision, (null === k || A > k) && (g.copy(j, q), k = A, m = l)
                        }
                    }
                    return m
                };
                var bb = g.fromValues(0, 0),
                    cb = g.fromValues(0, 0),
                    db = g.fromValues(0, 0);
                ...
                c.prototype[o.CIRCLE | o.HEIGHTFIELD] = c.prototype.circleHeightfield = function(a, b, c, d, e, f, j, k, l, m) {
                    ...
                    if (B) {
                        ...
                        return g.copy(E.normalA, s), g.scale(E.contactPointB, E.normalA, -m), i(E.contactPointB, E.contactPointB, c), h(E.contactPointB, E.contactPointB, a.position), g.copy(E.contactPointA, r), g.sub(E.contactPointA, E.contactPointA, e.position), this.contactEquations.push(E), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(E)), 1
                    }
                    if (m > 0)
                        for (var A = w; x >= A; A++)
                            if (g.set(u, A * o, n[A]), g.add(u, u, j), g.sub(p, c, u), g.squaredLength(p) < m * m) {
                                if (l) return !0;
                                var E = this.createContactEquation(e, a, f, b);
                                return g.copy(E.normalA, p), g.normalize(E.normalA, E.normalA), g.scale(E.contactPointB, E.normalA, -m), i(E.contactPointB, E.contactPointB, c), h(E.contactPointB, E.contactPointB, a.position), h(E.contactPointA, u, j), i(E.contactPointA, E.contactPointA, j), h(E.contactPointA, E.contactPointA, e.position), this.contactEquations.push(E), this.enableFriction && this.frictionEquations.push(this.createFrictionFromContact(E)), 1
                            }
                    return 0
                }
            }, {
        ...
        13: [
            function(a, b) {
                ...
                c.prototype.getCollisionPairs = function() {
                    ...
                    c.sortAxisListX(a), c.sortAxisListY(b);
                    for (var g = 0, i = a.length; g !== i; g++)
                        for (var j = a[g], k = g + 1; i > k; k++) {
                            var l = a[k];
                            if (!c.checkBounds(j, l, 0)) break;
                            if (e.canCollide(j, l)) {
                                var m = j.id < l.id ? j.id + " " + l.id : l.id + " " + j.id;
                                f[m] = !0, f.keys.push(m)
                            }
                        }
                    for (var g = 0, i = b.length; g !== i; g++)
                        for (var j = b[g], k = g + 1; i > k; k++) {
                            var l = b[k];
                            if (!c.checkBounds(j, l, 1)) break;
                            if (e.canCollide(j, l)) {
                                var m = j.id < l.id ? j.id + " " + l.id : l.id + " " + j.id;
                                f[m] && this.boundingVolumeCheck(j, l) && d.push(j, l)
                            }
                        }
                    for (var n = f.keys, g = 0, i = n.length; g !== i; g++) delete f[n[g]];
                    return n.length = 0, d
        ...
        14: [
            function(a, b) {
                function c(a, b, c, d) {
                    d = d || {}, this.type = c, this.equations = [], this.bodyA = a, this.bodyB = b, this.collideConnected = "undefined" != typeof d.collideConnected ? d.collideConnected : !0, a && a.wakeUp(), b && b.wakeUp()
                }
                b.exports = c, c.prototype.update = function() {
        ...
        15: [
            function(a, b) {
                function c(a, b, c, g) {
                    g = g || {}, d.call(this, a, b, d.DISTANCE, g), this.distance = c;
                    var h;
                    ...
                    i.computeGq = function() {
                        return f.sub(j, b.position, a.position), f.length(j) - c
                    }, this.setMaxForce(h)
                }
                var d = a("./Constraint"),
            ...
            function(a, b) {
                ...
                c.prototype.computeGiMf = function() {
                    var a = this.bodyA,
                        ...
                        o = f(b),
                        p = this.G;
                    return g.scale(l, c, j), g.scale(m, h, k), this.transformedGmult(p, l, d * n, m, i * o)
        ...
        43: [
            function(a, b) {
                ...
                b.exports = c, c.prototype = new f, c.prototype.solve = function(a, b) {
                    ...
                    var o = j * (i - l - c * k),
                        p = k + o;
                    return n * h > p ? o = n * h - k : p > m * h && (o = m * h - k), f[a] += o, b.multiplier = f[a] / h, b.addToWlambda(o), o
                }
            }, {
                "../equations/FrictionEquation": 23,
                "../math/vec2": 30,
        ...
        45: [
            function(a, b) {
                ...
                b.exports = c, c.appendArray = function(a, b) {
                    ...
                    a.length = e
                }, c.ARRAY_TYPE = Float32Array || Array, c.extend = function(a, b) {
        ...
        49: [
            function(a, b) {
                ...
                if (b.exports = c, "undefined" == typeof performance && (performance = {}), !performance.now) {
                    var J = Date.now();
                    performance.timing && performance.timing.navigationStart && (J = performance.timing.navigationStart), performance.now = function() {
                        return Date.now() - J
                    }
                }
                ...
                var K = (j.create(), j.create(), j.create(), j.create(), j.create(), j.create(), j.create()),
                    L = j.fromValues(0, 0),
                    M = j.fromValues(0, 0),
                    N = (j.fromValues(0, 0), j.fromValues(0, 0));
                c.prototype.step = function(a, b, c) {
                    if (c = c || 10, b = b || 0, 0 === b) this.internalStep(a), this.time += a;
                        ...
                        this.time += b;
                        for (var f = this.time % a, g = 0; g !== this.bodies.length; g++) {
                            var h = this.bodies[g];
                            h.motionState !== s.STATIC && h.sleepState !== s.SLEEPING ? (j.sub(N, h.position, h.previousPosition), j.scale(N, N, f / a), j.add(h.interpolatedPosition, h.position, N), h.interpolatedAngle = h.angle + (h.angle - h.previousAngle) * f / a) : (j.copy(h.interpolatedPosition, h.position), h.interpolatedAngle = h.angle)
                        }
                    }
                    ...
                    for (var v = 0, E = z.length; v !== E; v += 2)
                        for (var F = z[v], G = z[v + 1], I = 0, J = F.shapes.length; I !== J; I++)
                            for (var L = F.shapes[I], M = F.shapeOffsets[I], N = F.shapeAngles[I], O = 0, P = G.shapes.length; O !== P; O++) {
                                var Q = G.shapes[O],
                                    R = G.shapeOffsets[O],
                                    S = G.shapeAngles[O],
                                    T = this.defaultContactMaterial;
                                if (L.material && Q.material) {
                                    var U = this.getContactMaterial(L.material, Q.material);
                                    U && (T = U)
                                }
                                this.runNarrowphase(o, F, L, M, N, G, Q, R, S, T, this.frictionGravity)
                            }
                    for (var V = this.overlappingShapesLastState, v = 0; v !== V.keys.length; v++) {
                        var W = V.keys[v];
                        if (V[W] === !0 && !this.overlappingShapesCurrentState[W]) {
                            var X = this.endContactEvent;
                            X.shapeA = V[W + "_shapeA"], X.shapeB = V[W + "_shapeB"], X.bodyA = V[W + "_bodyA"], X.bodyB = V[W + "_bodyB"], this.emit(X)
                        }
                    }
                    for (var v = 0; v !== V.keys.length; v++) delete V[V.keys[v]];
                    V.keys.length = 0;
                    for (var Y = this.overlappingShapesCurrentState, v = 0; v !== Y.keys.length; v++) V[Y.keys[v]] = Y[Y.keys[v]], V.keys.push(Y.keys[v]);
                    for (var v = 0; v !== Y.keys.length; v++) delete Y[Y.keys[v]];
                    Y.keys.length = 0;
                    ...
                    for (var v = 0; v !== m; v++) {
                        var _ = i[v];
                        _.sleepState !== s.SLEEPING && _.motionState !== s.STATIC && c.integrateBody(_, a)
                    }
                    for (var v = 0; v !== m; v++) i[v].setZeroForce();
                    if (f && (d = performance.now(), e.lastStepTime = d - b), this.emitImpactEvent)
                        for (var ab = this.impactEvent, v = 0; v !== o.contactEquations.length; v++) {
                            var bb = o.contactEquations[v];
                            bb.firstImpact && (ab.bodyA = bb.bodyA, ab.bodyB = bb.bodyB, ab.shapeA = bb.shapeA, ab.shapeB = bb.shapeB, ab.contactEquation = bb, this.emit(ab))
                        }
                ...
                c.integrateBody = function(a, b) {
                    var c = a.invMass,
                        ...
                        e = a.position,
                        f = a.velocity;
                    j.copy(a.previousPosition, a.position), a.previousAngle = a.angle, a.fixedRotation || (a.angularVelocity += a.angularForce * a.invInertia * b, a.angle += a.angularVelocity * b), j.scale(O, d, b * c), j.add(f, O, f), j.scale(P, f, b), j.add(e, e, P), a.aabbNeedsUpdate = !0
                    ...
                    if (0 !== (c.collisionGroup & g.collisionMask) && 0 !== (g.collisionGroup & c.collisionMask)) {
                        j.rotate(L, d, b.angle), j.rotate(M, h, f.angle), j.add(L, L, b.position), j.add(M, M, f.position);
                        var m = e + b.angle,
                            n = i + f.angle;
                        ...
                        if (p) {
                            ...
                            q = c.type < g.type ? p.call(a, b, c, L, m, f, g, M, n, r) : p.call(a, f, g, M, n, b, c, L, m, r);
                            var u = a.frictionEquations.length - t;
                            if (q) {
                                var v = !1,
                                    w = !1,
                                    x = j.squaredLength(b.velocity) + Math.pow(b.angularVelocity, 2),
                                    y = Math.pow(b.sleepSpeedLimit, 2),
                                    z = j.squaredLength(f.velocity) + Math.pow(f.angularVelocity, 2),
                                    A = Math.pow(f.sleepSpeedLimit, 2);
                                b.allowSleep && b.motionState === s.DYNAMIC && b.sleepState === s.SLEEPING && f.sleepState === s.AWAKE && f.motionState !== s.STATIC && z >= 2 * A && (v = !0), f.allowSleep && f.motionState === s.DYNAMIC && f.sleepState === s.SLEEPING && b.sleepState === s.AWAKE && b.motionState !== s.STATIC && x >= 2 * y && (w = !0), v && b.wakeUp(), w && f.wakeUp();
                                var B = c.id < g.id ? c.id + " " + g.id : g.id + " " + c.id;
                                if (!this.overlappingShapesLastState[B]) {
                                    var C = this.beginContactEvent;
                                    if (C.shapeA = c, C.shapeB = g, C.bodyA = b, C.bodyB = f, C.contactEquations.length = 0, "number" == typeof q)
                                        for (var D = a.contactEquations.length - q; D < a.contactEquations.length; D++) C.contactEquations.push(a.contactEquations[D]);
                                    this.emit(C)
                                }
                                var E = this.overlappingShapesCurrentState;
                                if (E[B] || (E[B] = !0, E.keys.push(B), E[B + "_shapeA"] = c, E.keys.push(B + "_shapeA"), E[B + "_shapeB"] = g, E.keys.push(B + "_shapeB"), E[B + "_bodyA"] = b, E.keys.push(B + "_bodyA"), E[B + "_bodyB"] = f, E.keys.push(B + "_bodyB")), "number" == typeof q && u > 1)
                                    for (var D = a.frictionEquations.length - u; D < a.frictionEquations.length; D++) {
                                        var F = a.frictionEquations[D];
    ...
    }), this.world = new p2.World(b), this.frameRate = 1 / 60, this.useElapsedTime = !1, this.materials = [], this.gravity = new Phaser.Physics.P2.InversePointProxy(this, this.world.gravity), this.walls = {
        left: null,
        right: null,
        top: null,
        bottom: null
